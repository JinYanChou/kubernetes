...
CREATE TABLE IF NOT EXISTS `dtab0001` (
  ...
  `PREM_SPEC_KEY1` VARCHAR(3) DEFAULT '' COMMENT `PREM_SPEC_KEY1` IS '費率檔特有欄位一',
  `PREM_SPEC_KEY2` VARCHAR(3) DEFAULT '' COMMENT `PREM_SPEC_KEY2` IS '費率檔特有欄位二',
